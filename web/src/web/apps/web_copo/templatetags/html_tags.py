...
def generate_table_records(profile_id=str(), component=str()):
    ...
    for r in records:
        ...
        },
        {
            "dc" : "dc.title",
            "vals" : [
                "collection of files for dspace test"
            ],
            "copo_id" : "title",
            "prefix" : "dc"
        },
        ...
        {
            "dc" : "dc.rights",
            "vals" : "Creative Commons",
            "copo_id" : "rights",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.creator Affiliation",
            "vals" : 'null',
            "copo_id" : "creator_affiliation",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=Country",
            "vals" : [
                "ISO 3166-2:GB"
            ],
            "copo_id" : "coverage_type_country",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage",
        ...
        {
            "dc" : "dc.rights copyright holder",
            "vals" : "",
            "copo_id" : "rights_copyright_holder",
            "prefix" : "dc"
        },
        {
            "dc" : "terms of use",
            "vals" : "",
            "copo_id" : "terms_of_use",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.rights RightsStatement",
            "vals" : "",
            "copo_id" : "rights_rightsstatement",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.rights license",
            "vals" : "",
            "copo_id" : "rights_license",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.subject vocab=GACS/AGROVOC/CAB",
            "vals" : [
                "http://aims.fao.org/aos/agrovoc/c_3237"
            ],
            "copo_id" : "subject_vocab",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=AEZ (FAO)",
            "vals" : [
                ""
            ],
            "copo_id" : "coverage_type_aez",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=translator",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_translator",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=ChronologicalPeriod eventtype=Single",
            "vals" : "",
            "copo_id" : "coverage_type_chronological_period_eventtype_single",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.relation isReferencedBy",
            "vals" : [
                ""
            ],
            "copo_id" : "relation_isreferencedby",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=ChronologicalPeriod eventtype=Start / End",
            "vals" : [
                ""
            ],
            "copo_id" : "coverage_type_chronological_period_eventtype_start_end",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.relation",
        ...
        {
            "dc" : "dc.relation references",
            "vals" : [
                ""
            ],
            "copo_id" : "relation_references",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=ChronologicalPeriod",
            "vals" : [
                ""
            ],
            "copo_id" : "coverage_type_chronological_period",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=Administrative Unit",
            "vals" : [
                ""
            ],
            "copo_id" : "coverage_type_administrative_unit",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.relation hasFormat",
            "vals" : [
                ""
            ],
            "copo_id" : "relation_hasformat",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=Region",
            "vals" : [
                ""
            ],
            "copo_id" : "coverage_type_region",
            "prefix" : "dc"
        },
        {
            "dc" : "event date",
        ...
        {
            "dc" : "dc.relation conformsTo",
            "vals" : [
                ""
            ],
            "copo_id" : "relation_conformsto",
            "prefix" : "dcterms"
        },
        {
            "dc" : "dc.relation replaces",
            "vals" : "",
            "copo_id" : "relation_replaces",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=Geoinformation Specialist",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_geoinformation_specialist",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=ServiceProvider",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_serviceprovider",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=Supervisor",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_supervisor",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=Data analyst",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_data_analyst",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=Producer",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_producer",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.relation isReplacedBy",
            "vals" : [
                ""
            ],
            "copo_id" : "relation_isreplacedby",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=HostingInstitution",
            "vals" : [
                "earlham institute"
            ],
            "copo_id" : "contributor_type_person_role_hostinginstitution",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=Editor",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_editor",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.relation HasMetadata",
            "vals" : [
                ""
            ],
            "copo_id" : "relation_hasmetadata",
            "prefix" : "dc"
        },
        {
            "dc" : "isMetadataFor",
            ...
            "copo_id" : "ismetadatafor",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.relation isRequiredBy",
            "vals" : [
                ""
            ],
            "copo_id" : "relation_isrequiredby",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=other",
            "vals" : [
                ""
            ],
            "copo_id" : "contributor_type_person_role_other",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=person role=ProjectLeader",
            "vals" : "",
            "copo_id" : "contributor_type_person_role_projectleader",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor type=Project",
            "vals" : "GC44578546",
            "copo_id" : "contributor_type_project",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.date type=completion",
            "vals" : "13/02/2019",
            "copo_id" : "date_type_completion",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.date type=availability",
            "vals" : "13/02/2019",
            "copo_id" : "date_type_availability",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contributor Project Lead Center",
            "vals" : "International Food Policy Research Institute (IFPRI)",
            "copo_id" : "contributor_project_lead_center",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.contact",
        ...
        },
        {
            ...
            "copo_id" : "contact_email",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=geospatial X",
            "vals" : [
                ""
            ],
            "copo_id" : "coverage_type_geospatial_x",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.coverage type=geospatial Y",
            "vals" : [
                ""
            ],
            "copo_id" : "coverage_type_geospatial_y",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.format",
        ...
        {
            "dc" : "dc.identifier type=identifier",
            "vals" : [
                "pubmed"
            ],
            "copo_id" : "identifier_type_identifier",
            "prefix" : "dc"
        },
        {
            "dc" : "dc.identifier type=bibliographiCitation",
            "vals" : 'null',
            "copo_id" : "identifier_type_bibliographicitation",
            "prefix" : "dcterms"
        },
        {
            "dc" : "dc.source",
        ...
        {
            "dc" : "relation",
            "vals" : "copo:5c654b1568236b2ab07b8c63",
            "copo_id" : "relation"
        }
    ]
