...
from web.apps.web_copo.wizards.datafile.broker_requests import BrokerRequests
...
def data_wiz(request):
    ...
    context = BrokerRequests(context=context,
...
def forward_to_figshare(request):
    ...
    kwarg = dict(datafile_ids=file_ids, redirect_url=redirect_url, complete='false', token_obtained='false')
