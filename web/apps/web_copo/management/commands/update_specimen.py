...
class Command(BaseCommand):
    ...
    def __init__(self):
        self.pass_word = os.getenv('WEBIN_USER_PASSWORD')
        self.user_token = os.getenv('WEBIN_USER').split("@")[0]
        self.ena_service = os.getenv('ENA_SERVICE') #'https://wwwdev.ebi.ac.uk/ena/submit/drop-box/submit/'
